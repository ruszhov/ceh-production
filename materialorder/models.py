...
class MaterialOrder(models.Model):
	...
	total_of_material = models.DecimalField("Сума", max_digits=9, decimal_places=2, null=True, blank=True)
	...
	total_of_paint = models.DecimalField("Сума", max_digits=9, decimal_places=2, null=True, blank=True)
	...
	total_of_other = models.DecimalField("Сума", max_digits=9, decimal_places=2, null=True, blank=True)
